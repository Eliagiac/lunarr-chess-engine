...
public static class Zobrist {
    ...
    public const string randomNumbersFileName = "RandomNumbers.txt";
	public static string randomNumbersPath;
	...
	{
        randomNumbersPath = Path.Combine(Application.persistentDataPath, randomNumbersFileName);
	...
	public static ulong CalculateZobristKey() {
        ...
        int epIndex = Board.EnPassantSquare != 0 ? Board.GetFile(FirstSquareIndex(Board.EnPassantSquare)) + 1 : 0;
